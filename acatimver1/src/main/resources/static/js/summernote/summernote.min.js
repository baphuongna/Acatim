/*! summernote1 v0.8.8 | (c) 2013- Alan Hong and other contributors | MIT license */ ! function(a) {
    ...
    var j = "ontouchstart" in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
        ...
        p = function(b, c) {
            ...
            return this.memos = {}, this.modules = {}, this.layoutInfo = {}, this.options = c, this.initialize = function() {
                ...
                this._destroy(), b.removeData("summernote1"), e.removeLayout(b, this.layoutInfo)
            }, this.reset = function() {
                var a = d.isDisabled();
                ...
                var c = a.extend({}, this.options.modules, a.summernote1.plugins || {});
                ...
                d && d.apply(b[0], c), b.trigger("summernote1." + a, c)
    ...
    a.fn.extend({
        summernote1: function() {
            ...
            e = a.extend({}, a.summernote1.options, e), e.langInfo = a.extend(!0, {}, a.summernote1.lang["en-US"], a.summernote1.lang[e.lang]), e.icons = a.extend(!0, {}, a.summernote1.options.icons, e.icons), e.tooltip = "auto" === e.tooltip ? !k.isSupportTouch : e.tooltip, this.each(function(b, c) {
                var d = a(c);
                if (!d.data("summernote1")) {
                    var f = new p(d, e);
                    d.data("summernote1", f), d.data("summernote1").triggerEvent("init", f.layoutInfo)
                }
            });
            var f = this.first();
            if (f.length) {
                var g = f.data("summernote1");
    ...
    a.summernote1 = a.summernote1 || {
        lang: {}
    }, a.extend(a.summernote1.lang, {
        "en-US": {
            font: {
                bold: "Bold",
                italic: "Italic",
    ...
    var S, T = function() {
        ...
        V = function(b) {
            ...
            this.events = {
                "summernote1.keydown": function(a, d) {
    ...
    var X = function(a) {
        ...
        $ = function(b) {
            var c = this,
                ...
                f = b.options;
            this.events = {
                "summernote1.mousedown": function(a, b) {
                    c.update(b.target) && b.preventDefault()
                },
                "summernote1.keyup summernote1.scroll summernote1.change summernote1.dialog.shown": function() {
                    c.update()
                },
                "summernote1.disable": function() {
                    c.hide()
                },
                "summernote1.codeview.toggled": function() {
                    c.update()
                }
            }, this.initialize = function() {
        ...
        _ = function(b) {
            ...
            this.events = {
                "summernote1.keyup": function(a, b) {
                    b.isDefaultPrevented() || c.handleKeyup(b)
                },
                "summernote1.keydown": function(a, b) {
                    c.handleKeydown(b)
                }
            }, this.initialize = function() {
        ...
        ba = function(b) {
            var c = this,
                ...
                e = b.options;
            this.events = {
                "summernote1.init summernote1.change": function() {
                    c.update()
                },
                "summernote1.codeview.toggled": function() {
                    c.update()
        ...
        da = function(b) {
            ...
            this.shouldInitialize = function() {
                ...
                g.toolbar = g.toolbar || [], g.toolbar.length ? b.invoke("buttons.build", f, g.toolbar) : f.hide(), g.toolbarContainer && f.appendTo(g.toolbarContainer), this.changeContainer(!1), d.on("summernote1.keyup summernote1.mouseup summernote1.change", function() {
        ...
        fa = function(b) {
            var c = this,
                ...
                e = b.options;
            this.events = {
                "summernote1.keyup summernote1.mouseup summernote1.change summernote1.scroll": function() {
                    c.update()
                },
                "summernote1.disable summernote1.dialog.shown": function() {
                    c.hide()
                }
            }, this.shouldInitialize = function() {
        ...
        ia = function(b) {
            ...
            this.events = {
                ...
                "summernote1.keyup summernote1.scroll summernote1.change": function() {
                    c.update()
                },
                "summernote1.disable": function() {
                    c.hide()
        ...
        ka = function(b) {
            ...
            this.createShortCutList = function() {
                ...
                var b = f.dialogsInBody ? a(document.body) : e,
                    c = ['<p class="text-center">', '<a href="http://summernote1.org/" target="_blank">summernote1 0.8.8</a> Ã‚Â· ', '<a href="https://github.com/summernote1/summernote1" target="_blank">Project</a> Ã‚Â· ', '<a href="https://github.com/summernote1/summernote1/issues" target="_blank">Issues</a>', "</p>"].join("");
                this.$dialog = d.dialog({
        ...
        la = function(b) {
            var c = this,
                ...
                e = b.options;
            this.events = {
                "summernote1.keyup summernote1.mouseup summernote1.scroll": function() {
                    c.update()
                },
                "summernote1.disable summernote1.change summernote1.dialog.shown": function() {
                    c.hide()
                },
                "summernote1.focusout": function(a, b) {
    ...
    a.summernote1 = a.extend(a.summernote1, {
        version: "0.8.8",
        ui: J,
        dom: o,
        plugins: {},
